...
// arXiv and OpenAlex ship their real adapters (science verticals); the
// remaining science seats still import the stub factories from types.js
// until their adapter tickets land.
