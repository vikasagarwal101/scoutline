...
describe("arXiv retry-hint seam — no documented emitter; no-op pin (#186 P2)", () => {
  // GROUND: arXiv documents NO delay-hint headers. This is a NO-OP pin: the status-map site now consults the parser, and with no hint headers present the error path must stay byte-identical (field absent).
  //
