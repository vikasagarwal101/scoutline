...
describe("batch manifest provider pin validation", () => {
  ...
  it("rejects a provider outside the registry", async () => {
    await assertRejects(
      ...
      'operations[0]: unknown provider "notaprovider". Built-in providers: zai, minimax, tavily, exa, brave, firecrawl, parallel, perplexity, jina, you, linkup, spider, bocha, arxiv, openalex, crossref, pubmed, europepmc.',    );
  });
