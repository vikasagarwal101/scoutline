...
describe("you registry wiring", () => {
  it("registers you in PROVIDER_IDS and the static registry", () => {
    ...
    // and spider integrate after you; searchapi and kagi precede the
    // science seats, which append last).
    assert.deepEqual(ids.slice(-9), ["spider", "bocha", "searchapi", "kagi", "arxiv", "openalex", "crossref", "pubmed", "europepmc"]);
    assert.deepEqual(ids.slice(9, 12), ["you", "linkup", "spider"]);
